	...
	<div class="row mx-auto">
		<div class="col-4 my-3">
			<div class="nav flex-column rounded shadow nav-pills bg-dark text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
				...
				<a class="nav-link shadow bg-dark py-4 text-white" id="v-pills-languages-tab" data-toggle="pill" href="#v-pills-languages" role="tab" aria-controls="v-pills-languages" aria-selected="false"><h6>Languages</h6></a>
				...
				<a class="nav-link shadow bg-dark py-4 text-white" id="v-pills-education-tab" data-toggle="pill" href="#v-pills-education" role="tab" aria-controls="v-pills-education" aria-selected="false"><h6>Education</h6></a>
				<a class="nav-link shadow bg-dark py-4 text-white" id="v-pills-skills-tab" data-toggle="pill" href="#v-pills-skills" role="tab" aria-controls="v-pills-skills" aria-selected="false"><h6>Skills</h6></a>
			</div>
		</div>
		<div class="col-8 my-2 px-2 d-block">
			<div class="tab-content pt-3" id="v-pills-tabContent">
				<div class="tab-pane fade show active body-text-size mx-auto" id="v-pills-objective" role="tabpanel" aria-labelledby="v-pills-objective-tab">
					<p>Solution-driven web developer excelling in highly collaborative or solo work environment, finding
				...
				<div class="tab-pane fade mx-auto" id="v-pills-languages" role="tabpanel" aria-labelledby="v-pills-languages-tab">
					<div class="container">
				...
				<div class="tab-pane fade mx-auto body-text-size" id="v-pills-education" role="tabpanel" aria-labelledby="v-pills-education-tab">
					...
					<p class="body-text-size">This cohort was ten weeks with eight hour class time for 5 days a week with
						intense fast pace learning.
					<p class="body-text-size">I collaborated with a team to create a web application where users can submit recipes and search the directory for a recipe they're looking for.</p>
						<p class="body-text-size"> we used languages such as PHP, mySQL, JSX, HTML, JavaScript, CSS, and skills like Object Oriented Programming. </p>
					<p class="body-text-size">We also had to create our own personal website during this ten week period with
						on-going assignments and assessments to prove our skills.</p>
				...
				<div class="tab-pane fade mx-auto body-text-size" id="v-pills-skills" role="tabpanel" aria-labelledby="v-pills-skills-tab">
					<h4>What makes me different from my peers?</h4>
						<p class="body-text-size"> I use my eye for design to really make my projects stand out.</p>
						<p class="body-text-size">After being a consumer for so long, I understand what makes a website
							aesthetically enticing and what people look for in a website's content. </p>
						<p class="body-text-size"> This is a skill that came from experience of being on the internet my entire life.</p>
						<p class="body-text-size"> Being experimental and trying new software is what gets me really far with learning new programs</p>
						<p class="body-text-size"> Comprehending new programs & software comes natural to me since I have experience
							in many other programs such as video editing software, live streaming software and text editing software.</p>
						<p class="body-text-size"> I also have troubleshooting experience from working at Apple and an internet service provider named Boingo.</p>
				</div>
			</div>
		</div>
	</div>
...
<section class="d-lg-none bg-light text-dark">
	...
	<div class="tab-content my-4 mx-4" id="pills-tabContent">
		<div class="tab-pane fade show active" id="pills-objective" role="tabpanel" aria-labelledby="pills-objective-tab">
			<p>Solution-driven web developer excelling in highly collaborative or solo work environment, finding solutions
				to challenges and focuses on client satisfaction.</p>
			<p>Proven experience with PHP, mySQL, JavaScript, HTML, CSS, and React.</p>
			<p>Experienced in building product for desktop, and mobile app users, meeting the highest quality standards
				for web design, user experience, best practices, usability and meeting deadlines.</p>
			<p>Responding to challenges by designing, developing solutions and building web applications aligned to customer’s services.</p>
			<p>Translating solutions into code and working across many different APIs, third-party integrations and databases.</p>
	...
	<div class="accordion d-lg-none" id="accordionExample">
		...
		<div id="collapseOne" class="collapse active" aria-labelledby="headingOne" data-parent="#accordionExample">
			<div class="card-body bg-secondary text-white" id="headingOne">
				<a href="https://deepdivecoding.com/fullstack/" class="text-white" target="_blank"><strong>CNM Ingenuity (October 2019 – December 2019)</strong></a>
				<p class="body-text-size">This cohort was ten weeks with eight hour class time for 5 days a week with
					intense fast pace learning.
				<p class="body-text-size">I collaborated with a team to create a web application where users can submit recipes and search the directory for a recipe they're looking for.</p>
				<p class="body-text-size"> we used languages such as PHP, mySQL, JSX, HTML, JavaScript, CSS, and skills like Object Oriented Programming. </p>
	...
	<div class="card bg-dark text-white d-lg-none">
		...
		<div id="collapseTwo" class="collapse m-0 bg-secondary" aria-labelledby="headingTwo" data-parent="#accordionExample">
			<div class="card-body text-white" id="headingTwo">
				<h4><strong>What makes me different from my peers?</strong></h4>
				<p class="body-text-size"> I use my eye for design to really make my projects stand out.</p>
				<p class="body-text-size">After being a consumer for so long, I understand what makes a website
					aesthetically enticing and what people look for in a website's content. </p>
				<p class="body-text-size"> This is a skill that came from experience of being on the internet my entire life.</p>
